...
$sql="SELECT title,filename,received_date,status FROM returnedassignment"; 
...
while($row = mysqli_fetch_array($result)) {
    ...
    if($status=='not completed'){
        echo "<td><a href='returndownload.php?download_file=". $row['filename']. "'"."><i class='fa fa-download fa-2x w3-text-red' aria-hidden='true'></i></a></td>";
    }else{
